...
from mytools.models import DatasetFromNii, DatasetFromNii_aug
import pathlib

torch.cuda.empty_cache() 

mod = "S12"
dataset_PET  = DatasetFromNii(csv_path='data/pet_cere_'+ mod +'.csv')
out_pth = "/home/wangd2/LRP/Train/PET_experiment/smooth/" + mod+ "/"


#out_pth = "/home/wangd2/LRP/Train/PET_experiment/aug_RmOutliers/model0/"
#dataset_PET = DatasetFromNii_aug(csv_path='data/Output_cere_RmOutliers.csv')
...
inference_PET(out_pth, dataset_PET)
