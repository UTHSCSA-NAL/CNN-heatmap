...
#SBATCH -J infMRIjbM0                      # Job name
#SBATCH -o log/%xo.txt	          # Name of stdout output file
#SBATCH -e log/%xe.txt	          # Name of stderr error file
...
python3 inf.py "jacobian" "MRI" "model0"
