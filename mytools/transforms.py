...
class Flip:
    ...
    Arguments:
        ...
        prob: probability to flip the image. Executes always when set to
             1. Default is 0.5
    """
    def __init__(self, axis=2, prob=1):
        self.axis = axis
        self.prob = prob
...
class CoronalFlip(Flip):
    ...
    def __init__(self, prob=0.5):
        super().__init__(axis=3, prob=prob)
...
class AxialFlip(Flip):
    ...
    """
    def __init__(self, prob=0.5):
        super().__init__(axis=4, prob=prob)
...
class CoronalTranslate(Translate):
    ...
    """
    def __init__(self, dist=(-3, 3)):
        super().__init__(axis=3, dist=dist)
...
class AxialTranslate(Translate):
    ...
    """
    def __init__(self, dist=(-3, 3)):
        super().__init__(axis=4, dist=dist)
